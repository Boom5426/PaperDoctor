...
def main() -> None:
    ...
    print(f"storyline_draft.json: {result['storyline_draft_path']}")
    print(f"core_claims_draft.json: {result['core_claims_draft_path']}")
    print(f"storyline_confirmed.json: {result['storyline_confirmed_path']}")
    print(f"core_claims_confirmed.json: {result['core_claims_confirmed_path']}")
    ...
    print(f"issue clusters: {result['issue_cluster_count']}")
